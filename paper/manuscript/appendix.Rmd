...
ggsave('appendix_figs/op_falsepositives.pdf', width = 7, height = 3)
...
ggsave('appendix_figs/activities_by_location.pdf', width = 7, height = 4)
...
ggsave('face_hand_by_motor.pdf', width=7, height=5)
```
