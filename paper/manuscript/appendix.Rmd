...
```{r det_perf_by_age, fig.width=6.5, fig.height=3.1, fig.cap="F-score of OpenPose hand and face detections in the gold sample by child and age. Size indicates number of detections age bin/child."}
