...
ggsave('appendix_figs/handdensity.pdf', width = 7, height = 3)
```
...
p1 <- ddd %>% filter(face_eval_ketan=="FP", label=="face") %>%
  mutate(x=left+0.5*width,
         y=top+0.5*height) %>% # could actually overplot all the face rectangles? prob very messy...
...
ggsave('appendix_figs/op_falsepositives.pdf', width = 7, height = 3.4)
...
ggsave('appendix_figs/rocs.pdf', width = 7, height = 3)
```
...
ggsave('appendix_figs/f_scores_by_thres.pdf', width = 7, height = 3)
ggsave('appendix_figs/f_scores_by_thres.png', device = "png", width = 7, height = 3)
...
ggsave('appendix_figs/fscore_by_age_child.pdf', width = 7, height = 5)
```
...
ggpubr::ggarrange(p1, p2, nrow=1)
ggsave('appendix_figs/fscore_by_location.pdf', width = 7, height = 3)
```
...
ggsave('appendix_figs/humans_vs_op.pdf', width = 7, height = 5)
...
ggsave('appendix_figs/activities_by_location.pdf', width = 8, height = 4)
...
ggsave('appendix_figs/activities_by_single_location.pdf', width = 7, height = 4)
...
ggsave('appendix_figs/prob_activity_by_single_location.pdf', width = 8, height = 4)
```
...
ggsave('appendix_figs/face_hand_density.pdf', width = 7, height = 7)
```
...
ggsave('appendix_figs/face_hand_by_motor.pdf', width=7, height=5)
```
