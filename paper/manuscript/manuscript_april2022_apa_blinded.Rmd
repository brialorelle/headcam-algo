...
ggsave('figs_pdfs/face_hand_contingency.pdf', width=7, height=3, units='in')
```
...
ggsave('figs_pdfs/dets_by_location.pdf', width=7, height=5, units='in')
```
...
ggsave('figs_pdfs/size_by_age.pdf', width=7, height=3, units='in')
```
...
ggsave('figs_pdfs/detailed_changes.pdf',units='in',width=7, height=3)
```
