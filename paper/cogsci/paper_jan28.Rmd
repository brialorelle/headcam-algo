...
We also found an unexpectedly high proportion of hands in the view of infants, even when restricting the field of view to the upper 60% of the visual field of the videos.  One possibility is that these videos contain the viewpoints of children not only during structured interactions (e.g., play sessions at home or in the lab) but during everyday activities when children may be simply observing the actions of caregivers and other people in their environment. Further work that examines the variability in the social information in view across different activity contexts may help elucidate this new finding.

Indeed, a coarse analysis based the location the videos were filmed in already highlights the variability of the the social information in view, both across locations and between individual children. Even within a given, well-defined context---e.g., mealtime in kitchens---there was considerable variability: S saw more faces than A in the kitchen, and more faces in the kitchen than in other locations. This is likely because there are at least three ways to feed a young child in a kitchen: 1) sitting in front of the child, facing them as they sit in a high chair; 2) sitting behind the child, holding them as they face outward, and 3) sitting side by side. Each of these positions offer the child differing degrees of visual access to face and hands. Thus, even while the social information in view may be variable across children in different activitiy contexts, these analyses suggest they could be stable within children's typical experience.
