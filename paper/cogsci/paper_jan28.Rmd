...
ggplot(wide_uncropped, 
       aes(x=age_day_bin, y=prop, 
           ...
           col=region)) +
  geom_point(alpha=.2) +
  geom_smooth(span=10, aes(weight = num_detect), show.legend = FALSE) + # geom_smooth(show.legend = FALSE) or move these below legend?
  geom_smooth(data = wide_cropped, aes(weight = num_detect), show.legend = FALSE, 
