...
```{r}
# replace NAs with FALSE to compare proportion hands detected
d_cropped <- d_cropped %>%
  replace_na(list(hand_detected = FALSE, face_detected = FALSE))
```
