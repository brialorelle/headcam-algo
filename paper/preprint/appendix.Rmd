...
```{r faceHandDensity, fig.width=6.5, fig.height=9, fig.cap="Each panel shows the average position of faces and hands in the visual field; each dot represents the average position from one video within a given age range."}
