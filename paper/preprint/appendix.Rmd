...
#summary(face_sit) # ns
tab_model(face_sit, show.re.var=F, dv.labels = "Proportion of Faces")
```
...
hand_sit <- lmer(prop_hands ~ age * sit + (1 | child_id), 
     data=face_hand_by_age_milestones) 
#summary(hand_sit) # ns
tab_model(hand_sit, show.re.var=F, dv.labels = "Proportion of Hands")
```
...
tab_model(face_cruise, show.re.var=F, dv.labels = "Proportion of Faces")
```
...
summary(hand_cruise) 
# cruise+*, age*cruise-.
tab_model(hand_cruise, show.re.var=F, dv.labels = "Proportion of Hands") # show.obs=F
```
...
tab_model(face_walk, show.re.var=F, dv.labels = "Proportion of Faces")
```
...
tab_model(hand_walk, show.re.var=F, dv.labels = "Proportion of Hands")
```
