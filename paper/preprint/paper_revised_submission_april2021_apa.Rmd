...
As shown in Figure \ref{fig:faceHandContingency}, we found that all three infants were more likely to see hands independently -- without the presence of a face -- than they were likely to see faces independently. 
That is, generally speaking when a face was present, a hand also tended to be present. 
