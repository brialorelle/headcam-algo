...
In prior work examining egocentric videos taken from the infant perspective, OpenPose performed comparably to other modern face detection models [@long2021automated].
...
```{r}
motor = read_csv(file=here::here('data/raw_data/saycam_walking_asq.csv'))  
